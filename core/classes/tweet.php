...
class Tweet extends User{
	...
	public function getTweetLinks($tweet){
		...
		$tweet = preg_replace("/#([\w]+)/", "<a href='http://localhost/BSbehance/hashtag/$1'>$0</a>", $tweet);		
		$tweet = preg_replace("/@([\w]+)/", "<a href='http://localhost/BSbehance/$1'>$0</a>", $tweet);
		return $tweet;		
	}
